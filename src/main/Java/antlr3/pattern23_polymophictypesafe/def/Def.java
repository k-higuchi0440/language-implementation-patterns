package antlr3.pattern23_polymophictypesafe.def; /***
...
import pattern.typing.pattern23_polymophictypesafe.scope.BlockScope;
import pattern.typing.pattern23_polymophictypesafe.scope.ClassScope;
import pattern.typing.pattern23_polymophictypesafe.scope.MethodScope;
import pattern.typing.pattern23_polymophictypesafe.scope.Scope;
import pattern.typing.pattern23_polymophictypesafe.symbol.*;
...
public class Def extends TreeFilter {
    ...
    public final void enterMethod() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                ...
                currentMethod = ms;
                ID1.symbol_$eq(Some.apply(ms)); // track in AST
    ...
    public final ret_return ret() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                ((CymbolAST)retval.start).symbol_$eq(Some.apply(currentMethod));
            }
    ...
    public final void varDeclaration() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                ...
                VariableSymbol vs = VariableSymbol.apply((ID3!=null?ID3.getText():null), type4, Some.apply(ID3));
                ID3.symbol_$eq(Some.apply(vs));         // track in AST
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    if ( state.backtracking==1 ) {
                      type = Type$.MODULE$.definePointerType(typeElement5);
                    }
