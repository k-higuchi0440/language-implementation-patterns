package antlr3.pattern24_syntaxdirected.q; /***
...
import pattern.interpreter.pattern24_syntaxdirected.q.*;
import scala.Option;
...
public class QParser extends Parser {
    ...
    public String getGrammarFileName() { return "/Users/parrt/research/book/TPDSL/Book/code/interp/syntax/Q.g"; }
        ...
        public QParser(TokenStream input, QInterpreter interpreter) {
            this(input);
    ...
    public final void print() throws RecognitionException {
        ...
        try {
            ...
            if(expr1 instanceof Option) expr1 = ((Option) expr1).getOrElse(() -> ResultSet.apply());

            interpreter.print((ResultSet) expr1);
    ...
    public final void table() throws RecognitionException {
        ...
        try {
            ...
            interpreter.createTable((tbl!=null?tbl.getText():null), (key!=null?key.getText():null), JavaConverters.asScalaBuffer(list_columns));
    ...
    public final void assign() throws RecognitionException {
        ...
        try {
            ...
            if(expr3 instanceof Option) expr3 = ((Option) expr3).getOrElse(() -> ResultSet.apply());

            interpreter.store((ID2!=null?ID2.getText():null), (ResultSet) expr3);
    ...
    public final void insert() throws RecognitionException {
        ...
        try {
            ...
            setFields5=setFields(interpreter.getTable((ID4!=null?ID4.getText():null)).get());

            state._fsp--;

            match(input,10,FOLLOW_10_in_insert213); 
            interpreter.insertInto((ID4!=null?ID4.getText():null), setFields5);
    ...
    public final void set(Row row) throws RecognitionException {
        ...
        try {
            ...
            row.setValue((ID6!=null?ID6.getText():null), new Value(expr7.toString()));
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    if(expr8 instanceof Option) {
                        Object rs = ((Option) expr8).getOrElse(() -> new Object());
                        if(rs instanceof ResultSet) {
                            expr8 = ((ResultSet) rs).firstValue();
                        }
                    }

                    if(expr8 instanceof String) {
                        expr8 = new Value((String) expr8);
                    }

                    value = interpreter.select((tbl!=null?tbl.getText():null), JavaConverters.asScalaBuffer(list_columns), (key!=null?key.getText():null), (Value) expr8);
                ...
                case 2 :
                    ...
                    {
                    value = interpreter.select((tbl!=null?tbl.getText():null), JavaConverters.asScalaBuffer(list_columns));
        ...
        try {
            ...
            switch (alt7) {
                case 1 :
                    ...
                    value = interpreter.load((ID9!=null?ID9.getText():null));
