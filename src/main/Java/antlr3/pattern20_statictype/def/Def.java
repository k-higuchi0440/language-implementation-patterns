package antlr3.pattern20_statictype.def; /***
...
import pattern.typing.pattern20_computetype.scope.BlockScope;
import pattern.typing.pattern20_computetype.scope.MethodScope;
import pattern.typing.pattern20_computetype.scope.Scope;
import pattern.typing.pattern20_computetype.scope.StructScope;
import pattern.typing.pattern20_computetype.symbol.MethodSymbol;
import pattern.typing.pattern20_computetype.symbol.StructSymbol;
import pattern.typing.pattern20_computetype.symbol.Symbol;
import pattern.typing.pattern20_computetype.symbol.VariableSymbol;
import pattern.typing.pattern20_computetype.symboltable.SymbolTable;
import pattern.typing.pattern20_computetype.type.*;
import scala.Option;
import scala.Some;
        ...
        try {
            ...
            switch (alt6) {
                case 1 :
                    ...
                    if ( state.backtracking==1 ) {
                      type = ArrayType.apply(typeElement6);
                    }
