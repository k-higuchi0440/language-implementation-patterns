package antlr3.pattern17_nestedscopes.defref; /***
...
public class DefRef extends TreeFilter {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                ...
                Type retType = (type2!=null?type2.tsym:null); // rule type returns a Type symbol
                      MethodSymbol ms = MethodSymbol.apply((ID1!=null?ID1.getText():null),retType,
                                                         Option.apply(currentScope));
                      currentScope = ms.copy(
                              ms.copy$default$1(),
                              ms.copy$default$2(),
                              ms.copy$default$3().map(c -> c.define(ms)), // def method in globals
                              ms.copy$default$4()
                      );       // set current scope to method scope
    ...
    public final type_return type() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
              retval.tsym = currentScope.resolve(input.getTokenStream().toString(
                input.getTreeAdaptor().getTokenStartIndex(retval.start),
                input.getTreeAdaptor().getTokenStopIndex(retval.start))).getOrElse(() -> NullTypeSymbol$.MODULE$);
            }
        }
        catch (RecognitionException re) {
            reportError(re);
    ...
    public final void assignment() throws RecognitionException {
        ...
        try {
            ...
            match(input, Token.UP, null); if (state.failed) return ;
            if ( state.backtracking==1 ) {
                      VariableSymbol vs = (VariableSymbol)currentScope.resolve((ID5!=null?ID5.getText():null)).getOrElse(() -> VariableSymbol.apply("null", NullTypeSymbol$.MODULE$));
    ...
    public final idref_return idref() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                      ...
                      Symbol s = currentScope.resolve((ID6!=null?ID6.getText():null)).getOrElse(() -> NullTypeSymbol$.MODULE$);
