...
public class Types extends TreeFilter {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
              if ( init!=null && init.evalType()!=null )
                  Type$.MODULE$.promoteDeclExprType(ID1, init);
            }
    ...
    public final ret_return ret() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                Type$.MODULE$.promoteReturnExprType((MethodSymbol)((CymbolAST)retval.start).symbol().get(), v);
            }
    ...
    public final void assignment() throws RecognitionException {
        ...
        try {
            ...
            match(input, Token.UP, null); if (state.failed) return ;
            if ( state.backtracking==1 ) {
              Type$.MODULE$.promoteAssignExprType(lhs, rhs);
            }
    ...
    public final arrayRef_return arrayRef() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                      ...
                      retval.type = Type$.MODULE$.arrayIndex(ID9, (expr10!=null?((CymbolAST)expr10.start):null));
                      ((CymbolAST)retval.start).evalType_$eq(Some.apply(retval.type));
    ...
    public final call_return call() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                      ...
                      retval.type = Type$.MODULE$.call(ID12, JavaConverters.asScalaBuffer(args));
                      ((CymbolAST)retval.start).evalType_$eq(Some.apply(retval.type));
    ...
    public final member_return member() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                      ...
                      retval.type = Type$.MODULE$.member((expr13!=null?((CymbolAST)expr13.start):null), ID14, symtab);
                      ((CymbolAST)retval.start).evalType_$eq(Some.apply(retval.type));
