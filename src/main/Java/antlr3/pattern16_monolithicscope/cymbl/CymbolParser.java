package antlr3.pattern16_monolithicscope.cymbl; /***
...
import pattern.symboltable.symbol.Type;
import pattern.symboltable.symbol.VariableSymbol;
...
public class CymbolParser extends Parser {
    ...
    public final SymbolTable compilationUnit(SymbolTable symtab) throws RecognitionException {
        this.symtab = symtab;
        try {
        ...
        try {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    retval.tsym = (Type)symtab.resolve("float").get();
                ...
                case 2 :
                    ...
                    retval.tsym = (Type)symtab.resolve("int").get();
            ...
            retval.stop = input.LT(-1);
             ...
             // ((Token)retval.start) is the first tree node matched by this rule
                System.out.println("line "+((Token)retval.start).getLine()+": ref "+retval.tsym.name());
