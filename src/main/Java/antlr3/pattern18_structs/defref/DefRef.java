package antlr3.pattern18_structs.defref; /***
...
import pattern.symboltable.scope.BlockScope;
import pattern.symboltable.scope.Scope;
import pattern.symboltable.symbol.*;
import scala.Option;
    ...
    public final void enterStruct() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                    ...
                    System.out.println("[scope] create " + (ID1!=null?ID1.getText():null) + "'s StructScope");
                    System.out.println("line "+ID1.getLine()+": def struct "+(ID1!=null?ID1.getText():null));
                    StructSymbol ss = StructSymbol.apply((ID1!=null?ID1.getText():null), Option.apply(currentScope));
    ...
    public final void enterMethod() throws RecognitionException {
        ...
        try {
            ...
            if ( state.backtracking==1 ) {
                      ...
                      MethodSymbol ms = MethodSymbol.apply((ID2!=null?ID2.getText():null),(type3!=null?type3.tsym:null),Option.apply(currentScope));
            ...
            if ( state.backtracking==1 ) {
              retval.tsym = (Type)currentScope.resolve(input.getTokenStream().toString(
                ...
                input.getTreeAdaptor().getTokenStopIndex(retval.start)))
                      .getOrElse(() -> NullTypeSymbol$.MODULE$);
            }
        }
        catch (RecognitionException re) {
            reportError(re);
            ...
            switch (alt6) {
                case 1 :
                    ...
                    if ( state.backtracking==1 ) {
                            ...
                            Symbol s = scope.resolveMember((ID7!=null?ID7.getText():null)).getOrElse(() -> NullTypeSymbol$.MODULE$);// resolve ID in scope
                            System.out.println("line "+ID7.getLine()+": ref "+
                                               m.name()+"."+(ID7!=null?ID7.getText():null)+" = "+s);
                ...
                case 2 :
                    ...
                    if ( state.backtracking==1 ) {
                            ...
                            Symbol s = currentScope.resolve((ID8!=null?ID8.getText():null)).getOrElse(() -> NullTypeSymbol$.MODULE$);
